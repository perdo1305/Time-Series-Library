...
class Exp_Long_Term_Forecast(Exp_Basic):
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            # Add this block to call the callback
            if self.callback is not None:
                # You can pass any additional metrics in the dict
                metrics = {"train_steps": train_steps}
                stop_training = self.callback(
                    epoch, train_loss, vali_loss, test_loss, metrics
                )
                if stop_training:
    ...
    def set_callback(self, callback_function):
        """Set callback function to be called after each epoch."""
