...
class Exp_Short_Term_Forecast(Exp_Basic):
    def __init__(self, args):
        ...
        # Set default frequency_map for non-M4 datasets
        if not hasattr(self.args, "frequency_map") and self.args.data != "m4":
    ...
    def _select_criterion(self, loss_name="MSE"):
        if self.args.data == "m4":
            ...
            # Standard losses for other datasets
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(
                ...
                # Special handling for M4 dataset with custom loss functions
                if self.args.data == "m4":
                    loss_value = criterion(
                        batch_x, self.args.frequency_map, outputs, batch_y, batch_y_mark
                    )
                else:
                    # Standard loss calculation for other datasets
