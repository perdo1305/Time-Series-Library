...
def optuna_objective(trial, args_template):
    ...
    #    args.batch_size / 32
    # )
    # fized learning rate for simplicity
    args.learning_rate = 1e-3

    # Number of attention heads - controls how many different attention patterns to learn
    args.n_heads = trial.suggest_categorical("n_heads", [4, 16])
    ...
    # Train model
    try:
        # Import wandb if not already imported
        import wandb
        ...
        if args.use_wandb:
            ...
            # Define callback function for logging to wandb
        ...
        # Now call train with the callback in place
        exp.train(setting)
